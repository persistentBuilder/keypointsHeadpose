...
from biwiDataLoader import retDataset
...
train_dataset = retDataset(path_and_ground_truth_file, 1)
train_dataset.kfldShuff(ks=tst)
#for line in train_dataset.lines:
#    print(line)

print("\n==============================\n")
test_dataset = retDataset(path_and_ground_truth_file, 0)
test_dataset.kfldShuff(ks=rndm)
